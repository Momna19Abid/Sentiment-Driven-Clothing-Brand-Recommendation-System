...
📁 Sentiment-Driven-Clothing-Brand-Recommendation-System/
│__ src/
│   ├── prediction.ipynb                  # BERT model training and prediction
│   └── utils.py                           # Utility functions for data processing
├── Brand_data.csv                         # Dataset (customer reviews)
├── sentiment_model.pt                     # Trained BERT model
...
##### 📢 Share your outputs on L# 👗 Sentiment-Driven Clothing Brand Recommendation System
